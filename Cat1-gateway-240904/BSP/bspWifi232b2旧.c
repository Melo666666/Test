...
//u8 wifi232b2.Heart_Buf[] = "HUIKEJI";//{0x48, 0x55, 0x49, 0x4B, 0x45, 0x4A, 0x49};
...
{
	char i, retry=0, *ptr=NULL, rcvLen=0, rcvBuf[50]={0};
...
static u8 str2Hex(char *str, u8 strLen, u8 base)
{
...
static void str2HexLong(char *str, u8 *convBuf)
{
	char i, *ptr=NULL;
	for(i=0; i<3; i++)
	{
